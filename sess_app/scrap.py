...
def get_departments():
    ...
    cookies = {
    'ASP.NET_SessionId': '3phnxa2ci4t0ybq1jklp5m1e',
    }
    ...
    headers = {
        ...
        'Host': 'sess.shirazu.ac.ir',
        'User-Agent': 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_14_5) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/12.1.1 Safari/605.1.15',
        'Accept-Language': 'en-us',
        'Referer': 'https://sess.shirazu.ac.ir/Sess/249069504118',
        'Connection': 'keep-alive',
    }

    response = requests.get('https://sess.shirazu.ac.ir/Sess/3022740309839', headers=headers, cookies=cookies)
...
def get_department_courses(departmentId, dep_progress):
    ...
    headers = {
        ...
        'Host': 'sess.shirazu.ac.ir',
        'User-Agent': 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_14_5) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/12.1.1 Safari/605.1.15',
        'Referer': 'https://sess.shirazu.ac.ir/Sess/3022740309839',
        'Accept-Encoding': 'br, gzip, deflate',
        'Connection': 'keep-alive',
    }
    ...
    response = requests.post('https://sess.shirazu.ac.ir/Sess/3022740309839', headers=headers, data=data, cookies=cookies)
...
def set_session_course(courseIdent, departmentId):
    ...
    response = requests.post('https://sess.shirazu.ac.ir/Sess/3022740309839', headers=headers, data=data)
    # soup = BeautifulSoup(response.text, "html.parser")
    # print(soup)
...
def get_course_time_room(courseIdent, departmentId):
    ...
    response = requests.get('https://sess.shirazu.ac.ir/Sess/3718038362263', headers=headers)
